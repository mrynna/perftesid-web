  ...
  (t.prototype.respChart = function (a, e, r, o) {
    ...
    return (function () {
      ...
      switch ((a.attr("width", l(i).width()), e)) {
        case "Line":
          t = new Chart(n, { type: "line", data: r, options: o });
          break;
        case "Doughnut":
          t = new Chart(n, { type: "doughnut", data: r, options: o });
          break;
        case "Pie":
          t = new Chart(n, { type: "pie", data: r, options: o });
          break;
        case "Bar":
          t = new Chart(n, { type: "bar", data: r, options: o });
          break;
        case "Radar":
          t = new Chart(n, { type: "radar", data: r, options: o });
          break;
        case "PolarArea":
          t = new Chart(n, { data: r, type: "polarArea", options: o });
      }
      return t;
    })();
  }),
