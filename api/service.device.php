...
$sql = "INSERT INTO tb_data(token, tegangan, arus, suhuPanel, suhuLingkungan, iradiasi, performa) VALUES ('$key', '$tegangan', '$arus', '$suhuPanel', '$suhuLingkungan', '$iradiasi', '$performa')";
