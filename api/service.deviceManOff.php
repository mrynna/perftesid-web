...
if (isset($_POST['key'])) {
  ...
  if ($token === array_search($token, $arrayData)) {
    ...
    $sql = "INSERT INTO tb_dataManOffline(token, tegangan, arus, suhuPanel, suhuLingkungan, iradiasi, performa, waktu) VALUES ('$token', '$tegangan', '$arus', '$suhuPanel', '$suhuLingkungan', '$iradiasi', '$performa', '$waktu')";
